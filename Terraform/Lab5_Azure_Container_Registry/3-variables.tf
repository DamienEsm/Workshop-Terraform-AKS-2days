...
variable "resourceGroupName" {
  type    = string
  default = "WEUDEERSGAKSF00"
}

#  Azure Container Registry name
variable "acrName" {
  type    = string
  default = "acrdam25112022"   # IMPORTANT : changer ce nom et mettre un nom unique (cf. https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-naming#example-names-storage)
}
